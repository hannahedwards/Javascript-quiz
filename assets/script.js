...
var allQuestions = {
    ...
    'String values must be inclosed within _______ when being assigned to variables: ': ['1: Commas', '2: Curly Brackets', '3: Quotes', '4: Parenthesis', 0],
...
function checkAnswer(i, arr) {
    return function () {
        ...
        if (question < Object.keys(allQuestions).length - 1) {
            question += 1;
...
function allDone() {
    ...
    answersEL.textContent = "Your final score is: " + correctAnswers;
